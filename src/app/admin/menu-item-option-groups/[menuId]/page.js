// app/admin/menu-item-option-groups/[menuId]/page.js
"use client";
...
export default function MenuItemOptionGroupsPage({ params }) {
  ...
  async function fetchData() {
    try {
      ...
      setMenuItemOptionGroups(menuOptionGroupsData);
      ...
      const availableOptionGroupsList = optionGroupsData.filter(
        (group) => !linkedOptionGroupIds.includes(group.id)
      );
  ...
  const toggleOptionGroupSelection = (id) => {
